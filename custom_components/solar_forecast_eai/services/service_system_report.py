...
"""
Diagnostics report generator for Solar Forecast Energy AI.
Generates monthly performance reports in Markdown format.
...
class SystemReportGenerator:
    ...
    async def _load_statistics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if row and row[0]:
                stats["total_consumption_kwh"] = row[0]
    ...
    def _build_report(
        ...
        # Total consumption
        total_consumption = statistics.get("total_consumption_kwh", 0)
        ...
        # Build Markdown
        lines = [
            "# Solar Forecast Energy AI - System Report",
            f"> Generated: {now.strftime('%Y-%m-%d %H:%M')} | Heat Pump: {capacity_kwp} kW",
            "",
            "---",
            "",
        ...
        lines.extend(
            [
                ...
                "---",
                "",
                "*Report by Solar Forecast Energy AI*",
                "",
                "*Created by [Zara-Toorox](https://github.com/Zara-Toorox)*",
            ]
        )
    ...
    def _get_star_trek_quote(self) -> str:
        """Return a random Star Trek quote related to energy/efficiency. @zara"""
        quotes = [
            "Energy efficiency is the hallmark of an advanced civilization. - Captain Picard",
            "Infinite diversity in infinite combinations... including COP optimization. - Spock",
            "Make it so! And by 'it', I mean maximum heating efficiency. - Captain Picard",
            "Beam up the thermal energy, Scotty! - Captain Kirk (probably)",
            "Resistance to energy optimization is futile. - The Borg",
            "Logic dictates that heat pump technology is the most efficient course of action. - Spock",
            "I'm giving her all she's got, Captain! The COP is at maximum! - Scotty",
            "Space: the final frontier. Energy efficiency: the home frontier. - Captain Kirk",
            "Today is a good day to save energy! - Worf",
            "The needs of the many outweigh the needs of the few... optimize your heat pump. - Spock",
            "Engage... maximum thermal efficiency! - Captain Picard",
            "Fascinating. Your COP has improved by 0.3 points. - Spock",
        ]
    ...
    def _calculate_seasonal_stats(self, history: List[Dict[str, Any]]) -> Dict[str, Any]:
        """Calculate consumption statistics per season. @zara"""
        stats = {
