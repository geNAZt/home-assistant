...
"""
Notification service for Solar Forecast Energy AI.
Handles persistent notifications via Home Assistant.
Supports priority levels: info, warning, error.
"""
...
# Notification IDs
NOTIFICATION_ID_DEPENDENCIES = "solar_forecast_eai_dependencies"
NOTIFICATION_ID_INSTALLATION = "solar_forecast_eai_installation"
NOTIFICATION_ID_SUCCESS = "solar_forecast_eai_success"
NOTIFICATION_ID_ERROR = "solar_forecast_eai_error"
NOTIFICATION_ID_ML_ACTIVE = "solar_forecast_eai_ml_active"
NOTIFICATION_ID_STARTUP = "solar_forecast_eai_startup"
NOTIFICATION_ID_FORECAST = "solar_forecast_eai_forecast"
NOTIFICATION_ID_LEARNING = "solar_forecast_eai_learning"
NOTIFICATION_ID_RETRAINING = "solar_forecast_eai_retraining"
NOTIFICATION_ID_FROST = "solar_forecast_eai_frost"
NOTIFICATION_ID_FOG = "solar_forecast_eai_fog"
NOTIFICATION_ID_WEATHER_ALERT = "solar_forecast_eai_weather_alert"
NOTIFICATION_ID_SNOW_COVERED = "solar_forecast_eai_snow_covered"
NOTIFICATION_ID_ADAPTIVE_CORRECTION = "solar_forecast_eai_adaptive_correction"
...
🖖 by **Zara-Toorox**"""
            ...
            await self._safe_create_notification(
                message=message,
                title="☀️ Solar Forecast Energy AI — Sarpeidion AI & DB-Version",
...
The AI model will be automatically retrained to account for the changed sensor configuration."""
            ...
            message = f"""**Solar Forecast Energy AI - Model Retraining Required**

{reason_text}

**Next Steps:**
- Training will be performed automatically
- If needed, manually start: Service `solar_forecast_eai.force_retrain`
