...
CREATE TABLE IF NOT EXISTS hourly_weather_actual (
    ...
    wind_speed_ms REAL,
    precipitation_mm REAL,
    precipitation_counter_mm REAL,
    precipitation_rate_max_mm_h REAL,
...
CREATE TABLE IF NOT EXISTS thermodynamics_calibration (
    bucket TEXT PRIMARY KEY,
    global_factor REAL NOT NULL DEFAULT 1.0,
    sample_count INTEGER NOT NULL DEFAULT 0,
    confidence REAL NOT NULL DEFAULT 0.0,
    hourly_factors_json TEXT
);

CREATE TABLE IF NOT EXISTS thermodynamics_state (
